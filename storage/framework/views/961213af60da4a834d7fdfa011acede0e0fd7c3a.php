            ...
            <div class="col-lg-3 mb-4">
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <br>&nbsp;
                        <h3 class="card-title text-nowrap mb-1"><?php echo e($numberOfUsers); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 mb-4">
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <br>&nbsp;
                        <h3 class="card-title text-nowrap mb-1"><?php echo e($instansis); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 mb-4">
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <br>&nbsp;
                        <h3 class="card-title text-nowrap mb-1"><?php echo e($sekolahs); ?></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 mb-4">
                <div class="card"
                    ...
                    <div class="card-body">
                        ...
                        <br>&nbsp;
                        <h3 class="card-title text-nowrap mb-1"><?php echo e($totalUnitPenempatans); ?></h3>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi_Manajemen_Kantor_v.1.2\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>