<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active">
            <a href="<?php echo e(route('crew.dashboard')); ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?php echo e(route('arsip_pembelajaran.index')); ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-file"></i>
...
<?php /**PATH C:\xampp\htdocs\Aplikasi_Manajemen_Kantor_v.1.2\resources\views/layoutss/sidebar.blade.php ENDPATH**/ ?>